package br.com.estado.advice;

import br.com.estado.exception.AbstractException;
import br.com.estado.exception.ApiException;
import br.com.estado.exception.error.ApiError;
import br.com.estado.exception.error.ApiError.ApiErrorBuilder;
import br.com.estado.exception.error.ValidationError;
import br.com.estado.exception.error.ValidationErrorBuilder;
...
import static br.com.estado.helper.ApiHelper.API_ERROR_MSG;

@RestControllerAdvice
public class EstadoAdvice extends ResponseEntityExceptionHandler {

  private Logger logger = LoggerFactory.getLogger(EstadoAdvice.class);
